...
function Action() {
  return (
    <div className='ml-40 mt-40 flex justify-between'>
        <Image
    ...
    <div className="mt-32">
      ...
      <div className="text-slate-800 text-4xl font-bold mt-9">
      Video in Live Action</div>
      <div className="text-neutral-500 text-sm leading-5 tracking-wide max-w-[351px] mt-9">
